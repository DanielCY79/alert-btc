...
class PriceActionBacktestServiceExecutionOrderTests {
    ...
    private Object openLongPosition(PriceActionBacktestService service) throws Exception {
        Method openPosition = PriceActionBacktestService.class.getDeclaredMethod(
                "openPosition",
                AlertSignal.class,
    ...
    private Object evaluatePosition(PriceActionBacktestService service,
                                    Object position,
                                    BinanceKlineDTO bar,
                                    int barIndex,
                                    List<TradeRecord> completedTrades,
                                    BacktestConfig config) throws Exception {
        Class<?> positionClass = Class.forName("com.mobai.alert.backtest.priceaction.PriceActionBacktestService$ManagedPosition");
        Method evaluatePositionOnBar = PriceActionBacktestService.class.getDeclaredMethod(
