...
class StrategyBacktestServiceMultiTimeframeTests {
    ...
    private Object newHigherTimeframeContext(List<BinanceKlineDTO> history) throws Exception {
        Class<?> contextClass = Class.forName("com.mobai.alert.strategy.backtest.StrategyBacktestService$HigherTimeframeBacktestContext");
